...
class Cube {
    companion object {
        ...
        fun getPolygons(): MutableList<MutableList<Float>> {
            ...
            polygons.add(mutableListOf(0f,5f,1f, 0f, 0f, 1f, 15f,0f, 0f,15f, 0f,0f))
            polygons.add(mutableListOf(0f,4f,5f, 0f, 0f, 1f, 15f,0f, 15f,15f, 0f,15f))
            polygons.add(mutableListOf(1f,5f,2f, 0f, 1f, 1f, 0f,0f, 0f,15f, 15f,0f))
            polygons.add(mutableListOf(6f,2f,5f, 0f, 1f, 1f, 15f,15f, 15f,0f, 0f,15f))
            polygons.add(mutableListOf(3f,2f,6f, 1f, 1f, 0f, 0f,0f, 15f, 0f, 15f,15f))
            polygons.add(mutableListOf(3f,6f,7f, 1f, 1f, 0f, 0f,0f, 15f,15f, 0f,15f))
