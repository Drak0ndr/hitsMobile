...
class ColorFilters: PhotoActivity() {
   suspend fun toGreen(bitmap: Bitmap): Bitmap {
    ...
    fun toGreenBasic(bitmap: Bitmap): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var x = 0
    ...
    fun toBlueBasic(bitmap: Bitmap): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var x = 0
    ...
    fun toRedBasic(bitmap: Bitmap): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var x = 0
    ...
    fun toYellowBasic(bitmap: Bitmap): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var x = 0
    ...
    fun toNegativeBasic(bitmap: Bitmap): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var x = 0
    ...
    fun toGrayBasic(bitmap: Bitmap): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var x = 0
    ...
    fun gausBlurBasic(bitmap: Bitmap, r: Float): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
        var kernel = mutableListOf<MutableList<Double>>()
    ...
    fun normalizeColorBasic(color:Float):Float {
        var newColor = color
        if (newColor > 1) {
            newColor = 1f
        }
    ...
    fun changeContrastBasic(bitmap: Bitmap, k: Float): Bitmap {
        var width = bitmap.width
        var height = bitmap.height
        var newBitmap = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888)
